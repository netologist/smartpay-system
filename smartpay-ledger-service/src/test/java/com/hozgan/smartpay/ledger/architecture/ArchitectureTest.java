package com.hozgan.smartpay.ledger.architecture;
...
@Tag("unit")
@DisplayName("smartpay-ledger-service — Architecture Fitness Tests")
class ArchitectureTest {
    ...
    static void setUp() {
        importedClasses = new ClassFileImporter()
                ...
                .importPackages("com.hozgan.smartpay.ledger");
    }
