package com.hozgan.smartpay.invoice.architecture;
...
@Tag("unit")
@DisplayName("smartpay-invoice-service — Architecture Fitness Tests")
class ArchitectureTest {
    ...
    static void setUp() {
        importedClasses = new ClassFileImporter()
                ...
                .importPackages("com.hozgan.smartpay.invoice");
    }
