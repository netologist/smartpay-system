package com.hozgan.smartpay.payment.architecture;
...
@Tag("unit")
@DisplayName("smartpay-payment-service — Architecture Fitness Tests")
class ArchitectureTest {
    ...
    static void setUp() {
        importedClasses = new ClassFileImporter()
                ...
                .importPackages("com.hozgan.smartpay.payment");
    }
    ...
    void noAutowiredFieldInjection() {
        ArchRule rule = noFields()
                .that().areDeclaredInClassesThat().doNotHaveSimpleName("PaymentService")
