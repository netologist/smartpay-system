package com.hozgan.smartpay.notification.architecture;
...
@Tag("unit")
@DisplayName("smartpay-notification-service — Architecture Fitness Tests")
class ArchitectureTest {
    ...
    static void setUp() {
        importedClasses = new ClassFileImporter()
                ...
                .importPackages("com.hozgan.smartpay.notification");
    }
